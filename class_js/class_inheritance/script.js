//when the object can acesses the properties and methods of the other
//object , it is called as inheritance , which can be achieved using extends keyword.
//Child class can acessesall properties and methods of parent class.
