...
// let number =[44,55,66,77];

// here .... is a spread operator which unpacks the number array.
...
// we can apply  spread operator to the string , which spreads out each individual
// character of a string into individuals character

//spread operator copies only the array itself to the new one, not the element.
